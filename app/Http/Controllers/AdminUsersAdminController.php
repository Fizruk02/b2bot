<?php namespace App\Http\Controllers;
	...
	class AdminUsersAdminController extends \App\Constructor\controllers\BTController {
	    ...
	    public function cbInit() {
	        ...
	        $this->col = [];
            //$this->col[] = array("label"=>"Телефон","name"=>"phone" );
            $this->col[] = array("label"=>"ФИО","name"=>"name" );
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Current Team Id","name"=>"current_team_id","type"=>"select2","required"=>TRUE,"validation"=>"required|min:1|max:255","datatable"=>"current_team,id"];
			...
			//$this->form[] = ["label"=>"Chat","name"=>"id_chat","type"=>"select2","required"=>TRUE,"validation"=>"required|min:1|max:255","datatable"=>"chat,id"];
			...
			//$this->form[] = ["label"=>"T Date","name"=>"t_date","type"=>"datetime","required"=>TRUE,"validation"=>"required|date_format:Y-m-d H:i:s"];
			//$this->form[] = ["label"=>"T Login","name"=>"t_login","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"T Password","name"=>"t_password","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Two Factor Confirmed At","name"=>"two_factor_confirmed_at","type"=>"datetime","required"=>TRUE,"validation"=>"required|date_format:Y-m-d H:i:s"];
			//$this->form[] = ["label"=>"Two Factor Recovery Codes","name"=>"two_factor_recovery_codes","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
			//$this->form[] = ["label"=>"Two Factor Secret","name"=>"two_factor_secret","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
			//$this->form[] = ["label"=>"User Hash","name"=>"user_hash","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
